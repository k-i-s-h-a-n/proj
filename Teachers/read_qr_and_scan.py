        ...
        if area <600000:
            ...
            for i in range(len(correctAns)):
                if correctAns[i] == 1:
                    ...
                    correctAns[i] = 'D'
                elif correctAns[i] == 'wrong':
                    correctAns[i] = 'incorrect' 
            
            result.clear()
            return qr_data,score_secured,correctAns
        ...
        # ############################### E L S E ###################################### #
            ...
            for i in range(0, len(l_1), 5):
                ...
                if p.count(1) == 1:
                    ...
                    usrAns_1.append("more than 1 option marked")
                    response.append("wrong")
                else:
                    usrAns_1.append("Not answered")
                    response.append("wrong")
            ...
            for i in range(0, len(l_2), 5):
                ...
                if p.count(1) == 1:
                    ...
                    usrAns_2.append("more than 1 option marked")
                    response.append("wrong")
                else:
                    usrAns_2.append("Not answered")
                    response.append("wrong")
            ...
            for i in range(0, (len(l_3)-15), 5):
                ...
                if p.count(1) == 1:
                    ...
                    usrAns_3.append("more than 1 option marked")
                    response.append("wrong")
                else:
                    usrAns_3.append("Not answered")
                    response.append("wrong")
            # print("User Answer of 3 = ", usrAns_3)
            correctAns+=usrAns_3
            ...
            # print("SCORE = ",float(format(percentage, '.2f')),"%")
            # global score_secured
            # print("Student Response = ",correctAns)
            ...
            for i in range(len(answers)):
                if answers[i] == 1:
                    ...
                    answers[i] = 'D'
                # else:
                #     answers[i] = "DON'T ANSWER"

            return qr_data,score_secured,correctAns,answers
